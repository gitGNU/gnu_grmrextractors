...
(h3 "MAILING LISTS")
(p "FCP has a single moderated mailing list, with an archive. "
   ...
   (a (@ (href "http://lists.nongnu.org/mailman/listinfo/fcp-generic"))
      "FCP mailing list page")
   " for more information on subscribing to the mailing list.")

(h3 "REPORT A BUG")
(p "If you think you have found a bug in FCP then please send as "
   "complete a report as possible to <fcp AT nongnu DOT org>. An easy "
   ...
   (br)
   (br)
   "If you have a patch for a bug in FCP that hasn't yet been fixed in "
